...
baseline
python -u train_RESM.py 20 full fitzpatrick RESM
python -u train_RESM.py 15 full ddi RESM
'''
...
def custom_load(
    ...
    # -----------------------------------------------------------------------------
    # for resample method
    samples_weight = np.array(train['RESM_weights'])
    # ---------------------------------------------------------------------------
    ...
    transformed_train = SkinDataset(
        ...
        transform=transforms.Compose([
            ...
            #     transforms.Lambda(lambda img: Weighted_sum(img))
            #     ]),
